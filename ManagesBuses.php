...
<?php
    ...
    $sqlget = "SELECT id, Bus_Name, Tel, Driver_Name FROM bus";
       ...
       while ($row=mysqli_fetch_array($sqldata,MYSQLI_ASSOC))
       {
        ...
        echo "<td>
                <button style='border:2px solid yellow; border-radius:7px; background-color:red; color:white;'>
                  <a href='UpdateBus.php?id=" . $row['id'] . "' style='color:white; text-decoration:none;'>Update</a>
                </button>
              </td>";
        echo "<td>
                <button style='border:2px solid yellow; border-radius:7px; background-color:red; color:white;'>
                  <a href='deleteBus.php?id=" . $row['id'] . "' style='color:white; text-decoration:none;'>Delete</a>
                </button>
              </td>";
        echo "</tr>";
      }
