  ...
  <body>
   ...
   <div class="container">
    <div class="form-sections">
      <!-- Form left -->
      <div class="Form-left">
      <h1><span class="black-text">Get In Touch</span></h1>
        <div class="line"></div> <!--border-bottom line-->
        <p><span class="black-text">Contact us for latest news and updates.</p><br>

        <!--first Heading -->
        <h4>ADDRESS</h4>
         <span>Hunter road,Warangal,Telangana</span>
         <hr><br><br>

         <!--second Heading -->
        <h4>PHONE</h4>
         <span>9505630464</span>
         <hr><br><br>

       <!--third Heading -->
        <h4>EMAIL</h4>
         <span>purnachandar@gmail.com</span>
         <hr> <br>
