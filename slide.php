...
<div class="hero-slider" data-carousel>
	<div class="carousel-cell" style="background-image: url(image/1.jpg);">
		...
		<div class="inner">
			...
			<h2 class="title">Enjoy your journey with our best facility...</h2>
	...
	<div class="carousel-cell" style="background-image: url(image/3.jpg);">
		<div class="overlay"></div>
		<div class="inner">
			<h3 class="subtitle">Luggage Safety</h3>
			<h2 class="title">Travel worry-free with our secure and monitored luggage compartments...</h2>
			<a href="home.php" class="btn">Go to Home</a>
		</div>
	</div>
</div>
